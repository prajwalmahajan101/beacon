...
/** OTel-aligned log record per spec/01-telemetry-record-spec.md §1. Schema version 1. */
public record LogRecord(
  ...
  public static LogRecord minimal(
      Instant timestamp,
      int severityNumber,
      String severityText,
      String body,
  ...
  public static final class Builder {
    ...
    /**
     * Copy every field of {@code r} into a fresh builder. Used by the M1.6 Redactor (attribute
     * swap) and Enricher (traceId/spanId stamp) to produce a modified record without mutating the
     * immutable input.
     */
    ...
    public Builder observedTimestamp(Instant ts) {
      this.observedTimestamp = ts;
      return this;
    }

    public Builder severityNumber(int n) {
      this.severityNumber = n;
      return this;
    }

    public Builder severityText(String t) {
      this.severityText = t;
      return this;
    }
    ...
    public Builder spanId(String id) {
      this.spanId = id;
      return this;
    }

    public Builder traceFlags(Integer flags) {
      this.traceFlags = flags;
      return this;
    }

    public Builder resource(Map<String, Object> r) {
      this.resource = r;
      return this;
    }

    public Builder scope(Map<String, Object> s) {
      this.scope = s;
      return this;
    }

    public Builder attributes(Map<String, Object> a) {
      this.attributes = a;
      return this;
    }
