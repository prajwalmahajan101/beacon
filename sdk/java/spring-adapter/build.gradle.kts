...
description = "Beacon SDK Spring Boot adapter — auto-wires BeaconSdk + BeaconLogbackAppender + " +
    "BeaconTaskDecorator for Spring Boot 3.x apps. See docs/adr/0009 + docs/adr/0022 (rename)."
