...
8. **M2.7** — `v0.3-m2` release cut: `CHANGELOG [v0.3-m2]`, `docs/M2-COMPLETE.md` retrospective (mirror `docs/M1-COMPLETE.md` shape — *what was harder than expected / what the conformance suite caught / what v2 needs / forward link to platform M3+*), git tag `v0.3-m2`. ✅ — v0.3-m2 cut 2026-07-05, CHANGELOG roll-up + docs/M2-COMPLETE.md retrospective + tag.
