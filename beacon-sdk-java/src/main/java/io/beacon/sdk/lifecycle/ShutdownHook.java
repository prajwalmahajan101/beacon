...
/**
 * JVM shutdown hook that drains the buffer within {@code shutdown_drain_timeout_ms}.
 * Records still unsent at timeout are written to the fallback sink. See spec/02 §2.6.
 * Implemented in M1.5.
 */
