...
/**
 * JUnit 5 Extension: after each test, asserts no Thread whose name starts with {@code "beacon-"} is
 * still alive. Catches a leaked {@code BatchFlusher} (or any other Beacon daemon) that a test
